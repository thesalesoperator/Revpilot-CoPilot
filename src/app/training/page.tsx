    ...
    <DashboardLayout>
      <div className="p-8">
        ...
        <div className="relative mb-8 overflow-hidden">
          <div className="absolute inset-0 bg-gradient-to-r from-[#5eead4]/10 via-[#5eead4]/10 to-[#5eead4]/10 rounded-2xl" />
          <div className="relative p-6">
            <div className="flex items-center justify-between">
              <div>
                <div className="flex items-center gap-3 mb-2">
                  <h1 className="text-3xl font-bold text-white">Training Center</h1>
                  <div className="px-3 py-1 rounded-full bg-gradient-to-r from-[#5eead4] to-[#5eead4] text-black text-xs font-bold">
                    {userProgress.rank}
                  </div>
                </div>
              ...
              <div className="flex items-center gap-4">
                <div className="text-center px-4 py-2 rounded-xl bg-[rgba(255,255,255,0.05)]">
                  <div className="flex items-center gap-1 justify-center">
                    ...
                    <span className="text-2xl font-bold text-[#5eead4]">{userProgress.currentStreak}</span>
                  </div>
                ...
                <div className="text-center px-4 py-2 rounded-xl bg-[rgba(255,255,255,0.05)]">
                  <div className="flex items-center gap-1 justify-center">
                    ...
                    <span className="text-2xl font-bold text-[#5eead4]">{userProgress.totalXP.toLocaleString()}</span>
                  </div>
        ...
        <div className="glass-card p-4 mb-8 bg-gradient-to-r from-[#5eead4]/10 to-[#5eead4]/10 border-[#5eead4]/30">
              ...
              return (
                <div
                  ...
                  className={`p-3 rounded-xl ${
                    isComplete
                      ? 'bg-[#5eead4]/20 border border-[#5eead4]/30'
                      : 'bg-[rgba(0,0,0,0.2)]'
                  }`}
                >
                  <div className="flex items-center justify-between mb-2">
                    <challenge.icon className={`w-4 h-4 ${isComplete ? 'text-[#5eead4]' : 'text-gray-400'}`} />
                    <span className={`text-xs font-bold ${isComplete ? 'text-[#5eead4]' : 'text-[#5eead4]'}`}>
                      {isComplete ? 'COMPLETE' : `+${challenge.xp} XP`}
                    </span>
                  </div>
                  <p className={`text-sm ${isComplete ? 'text-[#5eead4]' : 'text-white'}`}>{challenge.title}</p>
                  <div className="flex items-center gap-2 mt-2">
                    <div className="flex-1 h-1.5 bg-[rgba(255,255,255,0.1)] rounded-full">
                      <div
                        className={`h-full rounded-full ${
                          isComplete ? 'bg-[#5eead4]' : 'bg-gradient-to-r from-[#5eead4] to-[#5eead4]'
                        }`}
        ...
        <div className="mb-8">
          <div className="flex items-center gap-2 mb-4">
            <Star className="w-5 h-5 text-[#5eead4]" />
          ...
          >
            {/* Animated background */}
            <div className="absolute inset-0 bg-gradient-to-r from-[#5eead4]/20 via-gray-500/20 to-[#5eead4]/20 animate-pulse" />
            <div className="absolute top-0 right-0 w-64 h-64 bg-[#5eead4]/10 rounded-full blur-3xl" />

            <div className="relative flex items-center gap-6">
              <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-[#5eead4] to-gray-500 flex items-center justify-center">
              ...
              <div className="flex-1">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <span className="px-2 py-1 rounded-full bg-[#5eead4]/20 text-[#5eead4] text-xs font-bold animate-pulse">
                    HOT
                  </span>
                </div>
                ...
                <div className="relative flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      {section.premium && (
                        <span className="px-2 py-0.5 rounded-full bg-[#5eead4]/20 text-[#5eead4] text-xs font-bold">
                          PRO
                        </span>
                      )}
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        <span className="text-xs text-[#5eead4] font-semibold">{section.xpReward}</span>
        ...
        <div className="glass-card p-6">
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="flex items-center gap-2">
              <div className="px-3 py-1 rounded-full bg-gradient-to-r from-[#5eead4] to-[#5eead4] text-black text-sm font-bold">
                {userProgress.rank}
              </div>
              <ArrowRight className="w-4 h-4 text-gray-500" />
              <div className="px-3 py-1 rounded-full bg-gradient-to-r from-[#5eead4] to-[#5eead4] text-white text-sm font-bold opacity-50">
          ...
          <div className="w-full h-3 bg-[rgba(255,255,255,0.1)] rounded-full overflow-hidden">
            <div
              className="h-full bg-gradient-to-r from-[#5eead4] via-[#5eead4] to-[#5eead4] rounded-full transition-all duration-500"
              style={{ width: '65%' }}
            />
          </div>
